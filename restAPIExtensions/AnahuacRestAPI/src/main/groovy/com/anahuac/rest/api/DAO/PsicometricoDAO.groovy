	...
	public Result insertUpdatePsicometrico(Integer parameterP, Integer parameterC, String jsonData, RestAPIContext context) {
		...
		try {
			...
			if(rs.next()) {
				...
				pstm.setString(1, testPsicomInput.ajusteefectivo);
				pstm.setString(2, testPsicomInput.ajusteescolarprevio);
				pstm.setString(3, testPsicomInput.ajusteexistencial);
				pstm.setString(4, testPsicomInput.ajustemediofamiliar);
				pstm.setString(5, testPsicomInput.ajustemediosocial);
				pstm.setString(6, testPsicomInput.ajustereligioso);
				pstm.setString(7, testPsicomInput.califajusteafectivo);
				pstm.setString(8, testPsicomInput.califajusteescolarprevio);
				pstm.setString(9, testPsicomInput.califajusteexistencial);
				pstm.setString(10, testPsicomInput.califajustemediofamiliar);
				pstm.setString(11, testPsicomInput.califajustemediosocial);
				pstm.setString(12, testPsicomInput.califajustereligioso);
				pstm.setString(13, testPsicomInput.conclusioneinvp);
				pstm.setString(14, testPsicomInput.interpretacioninvp);
				pstm.setString(15, testPsicomInput.persistenceversion);
				pstm.setString(16, testPsicomInput.puntuacioninvp);
				pstm.setString(17, testPsicomInput.recomendadopca);
				pstm.setString(18, testPsicomInput.recomendadopcda);
				pstm.setString(19, testPsicomInput.recomendadopdp);
				pstm.setString(20, testPsicomInput.recomendadopdu);
				pstm.setString(21, testPsicomInput.recomendadopia);
				pstm.setString(22, testPsicomInput.recomendadosse);
				pstm.setString(23, testPsicomInput.fechaentrevista);
				pstm.setString(24, testPsicomInput.finalizado);
				pstm.setString(25, testPsicomInput.resumensalud);
				pstm.setString(26, testPsicomInput.otrotipoasistencia);
				pstm.setString(27, (catPersonaSaludable.persistenceId != null && catPersonaSaludable.persistenceId != "") ? catPersonaSaludable.persistenceId : 0);
				pstm.setString(28, (catProblemaSaludAtencionContinua.persistenceId != null && catProblemaSaludAtencionContinua.persistenceId != "") ? catProblemaSaludAtencionContinua.persistenceId : 0);
				pstm.setString(29, (catRequieresAsistencia.persistenceId != null && catRequieresAsistencia.persistenceId != "") ? catRequieresAsistencia.persistenceId : 0 );
				pstm.setString(30, (catVivesEstadoDiscapacidad.persistenceId != null && catVivesEstadoDiscapacidad.persistenceId != "") ? catVivesEstadoDiscapacidad.persistenceId : 0);
				pstm.setString(31, testPsicomInput.hasparticipadoactividadesayuda);
				pstm.setString(32, testPsicomInput.participacionactividadesvoluntaria);
				pstm.setString(33, testPsicomInput.quienintegro);
				pstm.setString(34, testPsicomInput.quienrealizoentrevista);
				pstm.setString(35, testPsicomInput.caseid);
				pstm.executeUpdate();
			}
