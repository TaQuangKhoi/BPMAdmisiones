...
class AppMenuRole extends BusinessAppMenu{
	...
	public static String CREATE ="CREATE TABLE public.app_menu_role (id bigserial NOT NULL, business_app_menuid bigint NOT NULL, roleid bigint NOT NULL, PRIMARY KEY (id) );"
