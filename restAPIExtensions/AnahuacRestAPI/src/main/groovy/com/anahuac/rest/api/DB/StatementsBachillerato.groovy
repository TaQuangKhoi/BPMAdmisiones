...
class StatementsBachillerato {
	...
	public static final String GET_DESCUENTOS_CAMPANA="SELECT c.* FROM CatDescuentos c WHERE c.tipo = 'Campaña' AND isEliminado is false AND CURRENT_TIMESTAMP BETWEEN  TO_DATE(c.inicioVigencia,'YYYY-MM-DD HH24:MI:SS') AND TO_DATE(c.finVigencia,'YYYY-MM-DD HH24:MI:SS') AND c.campus = ? ORDER BY c.persistenceId ASC"
