...
class ReportesDAO {
	...
	public Result generarReporteRelacionAspirantes(String jsonData) {
		...
		try {
            ...
            //where += " WHERE sda.catcampus_pid=" + object.campus
			where += " WHERE (campus.clave in (${condicion }) OR campus2.clave in (${condicion }))"
