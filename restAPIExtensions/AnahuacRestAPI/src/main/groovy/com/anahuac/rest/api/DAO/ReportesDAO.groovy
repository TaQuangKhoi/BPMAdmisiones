...
>>>>>>> e54b2712 (actualizacion de importacionPAA)
    ...
    public Result generarReporteResultadosExamenes(String jsonData) {
        ...
        try {
            ...
            def titulos = ["Universidad", "Periodo", "Número de matrícula", "Nombre", "Carrera", "Preparatoria de procedencia", "Religión", "Sexo", "Tipo de admisión", "Sesión", "Promedio", "INVP", "PAAV", "CLEX", "PAAN", "MLEX", "PARA", "HLEX", "PAAT", "PDP", "PDU", "SSE", "PCDA", "PCA", "Campus ingreso", "Tipo de estudiante", "CURP", "Decisión de admisión", "PDP", "PDU", "SSE", "PCDA", "PCA", "Observaciones"]
            if (object.encabezado) {
    ...
    public Result generarReporteAdmitidosPropedeutico(String jsonData) {
        ...
        try {
            ...
            def titulos = ["Nombre", "No. Matrícula", "Email", "Teléfonos", "Celular", "Ciudad(procedencia preparatoria)", "Preparatoria", "Promedio", "Clave carrera","Clave Propedéutico", "Nombre de propedeutico", "Tipo Admisión", "Solicitud Admisión", "Pago de Examen", "Autodescripción", "Selección Fechas", "Esperando resultados", "Resultado de admisión", "Fecha admisión", "Pago curso", "Tipo de Estudiante"]
            if (object.encabezado) {
                fw.write((titulos.join(",") + "\r\n").getBytes());
                Row headersRow = sheet.createRow(rowCount);
                ++rowCount;
