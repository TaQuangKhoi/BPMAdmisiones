		...
		try {
				...
				String sDate = formatter.format(date);
				 ...
				 object.each{
					 ...
					 pstm = con.prepareStatement((existe?Statements.INSERT_BITACORA_ERRORES_RC.replace("[IDBANNER]", it.idBanner):Statements.INSERT_BITACORA_ERRORES_RC), Statement.RETURN_GENERATED_KEYS)
					 pstm.setString(1, it.Error);
					 pstm.setString(2, it.idBanner)
					 pstm.setString(3, it.usuario)
