...
class StatementsCatalogos {
	...
	public static final String GET_CAMPUS_CONFIG = "SELECT PERSISTENCEID, DESCUENTOPRONTOPAGO, IDCAMPUS, INTERESCOLEGIATURA, INTERESINSCRIPCION, PORCENTAJEINTERESFINANCIAMIENTO, TIENEFINANCIAMIENTO, URLREGLAMENTO, PROMEDIOMINIMO  FROM CONFIGURACIONESCAMPUS WHERE  IDCAMPUS = ?;";
	...
	public static final String UPDATE_CAMPUS_CONFIG = "UPDATE CONFIGURACIONESCAMPUS SET DESCUENTOPRONTOPAGO = ?, INTERESCOLEGIATURA = ?, INTERESINSCRIPCION = ?, PORCENTAJEINTERESFINANCIAMIENTO = ?, TIENEFINANCIAMIENTO = ?, URLREGLAMENTO = ?, PROMEDIOMINIMO = ? WHERE IDCAMPUS = ?";
