...
class StatementsCatalogos {
	...
	/*Gestion Escolar */
	public static final String INSERT_SDAECAT_GESTION_ESCOLAR = "INSERT INTO SDAECATGESTIONESCOLAR (PERSISTENCEID,PERSISTENCEVERSION,PARCIALIDAD,CREDITOSEMESTRE,MANEJOAPOYO,CATGESTIONESCOLAR_PID) VALUES (case when (SELECT max(persistenceId)+1 from SDAECatGestionEscolar ) is null then 1 else (SELECT max(persistenceId)+1 from SDAECatGestionEscolar) end,0,?,?,?,?) ";
	...
	public static final String GET_EXISTE_SDAECAT_GESTION_ESCOLAR = "SELECT PERSISTENCEID FROM SDAECATGESTIONESCOLAR WHERE CATGESTIOESCOLAR_PID = ?";
	...
	public static final String UPDATE_SDAECAT_GESTION_ESCOLAR = "UPDATE SDAECATGESTIONESCOLAR SET PARCIALIDAD = ?,CREDITOSEMESTRE = ?,MANEJOAPOYO = ? WHERE PERSISTENCEID = ?";
	...
	public static final String GET_SDAECAT_GESTION_ESCOLAR = "SELECT PERSISTENCEID,PARCIALIDAD,CREDITOSEMESTRE,MANEJOAPOYO,CATGESTIONESCOLAR_PID FROM SDAECATGESTIONESCOLAR WHERE CATGESTIONESCOLAR_PID = ?"
}
