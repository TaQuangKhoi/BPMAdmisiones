function WidgetlivingApplicationMenuController($scope, $http, $window, $location, $timeout, modalService) {
  ...
  //       Pase de lista college board
    ...
    function setApplication(){
        ...
        console.log("=======================================================================================")
        console.log("$scope.properties.currentTaskName: "+$scope.properties.currentTaskName+" ==============")
        if($scope.properties.currentTaskName === ""){

            console.log("$scope.properties.currentTaskName: "+$scope.properties.currentTaskName+" ==============")
            if($scope.properties.objectSolicitudVencida.estatusSolicitud === "Resultado final del comité"){
    ...
    $scope.$watch("properties.currentTaskName", function(){
        ...
        //     setApplication();    
        // }
        //if(($scope.properties.isCaseStarted && $scope.properties.currentTaskName !== "") || (!$scope.properties.isCaseStarted && $scope.properties.currentTaskName === "")){
        if($scope.properties.isCaseStarted){
            ctrl.appStarted = true;
            setApplication();
        } 
    });
