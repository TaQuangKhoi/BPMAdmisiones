function PbButtonCtrl($scope, $http, $location, $log, $window, localStorageService, modalService) {
    ...
    this.action = function action() {
        doRequest("GET", "/API/bpm/process?p=0&c=10&o=displayName%20DESC&f=activationState%3dENABLED&f=name=SubidaEAC_BANNER", null, null, function(respuesta) {
            var processid = respuesta[0].id;
            doRequest("GET", `../API/bpm/processParameter?c=5&f=process_id=${processid}&o=name+ASC&p=0`, null, null, function(respuesta) {
