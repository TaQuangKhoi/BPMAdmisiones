function PbInputCtrl($scope, $log, widgetNameFactory) {
    ...
    $scope.forceKeyPressUppercase = function(e) {
        /*console.log("forceKeyPressUppercase")
        let charInput = e.keyCode;
        let year = 0;
        let limite = $scope.properties.maxLength === 1 ? 250 : $scope.properties.maxLength;
    ...
    $scope.forceKeyUp = function(e) {
        console.log("forceKeyUp")
        let year = 0;
        let charInput = e.keyCode;
        let limite = $scope.properties.maxLength === 1 ? 250 : $scope.properties.maxLength;
        if (e.target.value.length === limite) {
    ...
    $scope.validar = function(e) {
        if (window.mobileAndTabletCheck()) {
            ...
            let lsc = $scope.properties.value.substring($scope.properties.value.length - 1);
            if (isNaN(lsc)) {
                $scope.properties.value = $scope.properties.value.slice(0, -1)
            }
        }
