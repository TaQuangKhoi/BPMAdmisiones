$(document).ready(function() {
    ...
    function goPlayAnimation() {
        ...
        //  setTimeout(function() {  document.getElementById("nameHolder").style.opacity=1; }, 1000);
        //  setTimeout(function() {  document.getElementById("apesHolder").style.opacity=1; }, 1400);
        //  setTimeout(function() {  document.getElementById("expHolder").style.opacity=1; }, 1800);
        // document.getElementById("nameHolder").style.opacity=0;
        // document.getElementById("apesHolder").style.opacity=0;   
        // document.getElementById("expHolder").style.opacity=0;  
        
       
        // setTimeout(function() { TweenMax.staggerFrom('.nameHolder', 1, { opacity: 1, color: '#ef6b00', ease: Power2.easeOut, delay: 16.5 }, 0.1); }, 16000);
        // setTimeout(function() { TweenMax.staggerFrom('.apesHolder', 1, { opacity: 1, color: '#ef6b00', ease: Power2.easeOut, delay: 16.5 }, 0.1); }, 16500);
        // setTimeout(function() { TweenMax.staggerFrom('.expHolder', 1, { opacity: 1, color: '#ef6b00', ease: Power2.easeOut, delay: 16.5 }, 0.1); }, 17000);
        ...
        //LETTERS APPEAR
            ...
            setTimeout(function() {  document.getElementById("nameHolder").style.transition = "ease all .3s"; }, 16000);
            setTimeout(function() {  document.getElementById("nameHolder").style.opacity=1; }, 16000);
            
            setTimeout(function() {  document.getElementById("apesHolder").style.transition = "ease all .3s"; }, 17000);
            setTimeout(function() {  document.getElementById("apesHolder").style.opacity=1; }, 17000);
            
            setTimeout(function() {  document.getElementById("expHolder").style.transition = "ease all .3s"; }, 18000);
            setTimeout(function() {  document.getElementById("expHolder").style.opacity=1; }, 18000);

        //  setTimeout(function() {  document.getElementById("nameHolder").style.opacity=1; }, 16000);
        //  setTimeout(function() {  document.getElementById("apesHolder").style.opacity=1; }, 16500);
        //  setTimeout(function() {  document.getElementById("expHolder").style.opacity=1; }, 17000);
