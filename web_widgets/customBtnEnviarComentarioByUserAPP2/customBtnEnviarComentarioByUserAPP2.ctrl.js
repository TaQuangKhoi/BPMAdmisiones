function PbButtonCtrl($scope, $http, $location, $log, $window, localStorageService, modalService, blockUI) {
    ...
    $scope.getComentarios = function() {
        ...
        var req = {
            method: "GET",
            url: `/API/extension/AnahuacRestGet?url=postGetCatBitacoraComentariosPsicometrico&p=0&c=9999&usuario=${$scope.properties.userComentario != null?$scope.properties.userComentario:''}`
        };
