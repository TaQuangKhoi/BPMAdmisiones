function PbSelectCtrl($scope, $parse, $log, widgetNameFactory, $timeout, $window, $element) {
  ...
  $scope.$watchCollection('properties.availableValues', function(items) {
    ...
    $scope.resetCP = function(_changeInside){
        if(_changeInside){
            $scope.properties.formOutput.solicitudApoyoEducativoInput.estado = "";
            $scope.properties.formOutput.solicitudApoyoEducativoInput.delegacionCiudad = "";
            $scope.properties.formOutput.solicitudApoyoEducativoInput.colonia = "";
            $scope.properties.formOutput.solicitudApoyoEducativoInput.codigoPostal = "";
        }
    }
