function PbTableCtrl($scope, $http, $window, blockUI, modalService) {
    ...
    $scope.openModal = function(row) {
        ...
        var url = "/portal/resource/app/administrativo/solicitudVencida/content/?app=administrativo/?persistenceId=[PERSISTENCEID]";
        url = url.replace("[PERSISTENCEID]", row.persistenceid);
