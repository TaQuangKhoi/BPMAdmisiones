   ...
   */
    ...
    */
    ...
    function uploadComplete(response) {
        ...
        updateTipoApoyoVideo();
    }

    function updateTipoApoyoVideo(){
        debugger;
        let objData = angular.copy($scope.properties.tipoApoyoSeleccionado);
        objData["idCampus"] = $scope.properties.idCampus
        var req = {
            method: "POST",
            url: $scope.properties.urlUpdateCurriculum,
            data: objData
        };
