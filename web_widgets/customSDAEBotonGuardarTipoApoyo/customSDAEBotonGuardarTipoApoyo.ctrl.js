function PbButtonCtrl($scope, $http, $location, $log, $window, localStorageService, modalService) {
    ...
    function valiateTipoApoyo() {
        let output = true;
        let messageTitle = "", errorMessage = "";
        let objValidate = angular.copy($scope.properties.dataToSend);

        if(!objValidate.clave){
            messageTitle = "¡Orden!";
            errorMessage = "El campo 'Orden' no debe ir vacío";
            output = false;
        } else if(!objValidate.descripcion){
            messageTitle = "¡Descripción!";
            errorMessage = "El campo 'Descripción' no debe ir vacío";
            output = false;
        } else if (objValidate.requiereVideo && !objValidate.condicionesVideo){
            messageTitle = "Condiciones de video!";
            errorMessage = "Si seleccionaste el campo '¿Requiere video?', el campo 'Condiciones de video' no debe ir vacío";
            output = false;
        }
