function PbTableCtrl($scope, $http, modalService) {
    ...
    $scope.cambioRed = function(row,index){
        if ($scope.loading == false) {
            $("#loading").modal("show");
            $scope.loading = true;
            $scope.properties.contenido[index].perteneceRed = !$scope.properties.contenido[index].perteneceRed;
            $scope.asignarTarea()
        } else {
    ...
    $scope.modificarData = function(row, index) {
            ...
            $scope.properties.selectedToModificate = [{"clave":"","descripcion":"","pais":"","estado":"","ciudad":"","isEliminado":false,"isEnabled":true,"perteneceRed":"","persistenceId_string":""}];
            ...
            $scope.properties.selectedToModificate[0].ciudad = $scope.properties.contenido[index].ciudad;
            $scope.properties.selectedToModificate[0].fechaImportacion = $scope.properties.contenido[index].fechaImportacion;
            $scope.properties.selectedToModificate[0].perteneceRed = $scope.properties.contenido[index].perteneceRed;
