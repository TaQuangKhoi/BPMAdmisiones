function PbTableCtrl($scope, $http, $location, $log, $window, localStorageService, modalService,blockUI) {
            ...
            .then((value) => {
                switch (value) {
                    case "Si":
                        ...
                        var req = {
                            method: "GET",
                            url: "/API/bdm/businessData/com.anahuac.catalogos.CatPropedeuticoGral?q=findByPersistenceId&p=0&c=9999&f=persistenceId="+row.persistenceId
                        };
                        return $http(req)
                            .success(function(data, status) {
                                ...
                                $scope.dataToSendDelete.catPropedeuticoGralInput["persistenceId"]=data[0].persistenceId;
                                $scope.dataToSendDelete.catPropedeuticoGralInput["persistenceId_string"]=data[0].persistenceId_string;
                                $scope.dataToSendDelete.catPropedeuticoGralInput["persistenceVersion"]=data[0].persistenceVersion;
                                $scope.dataToSendDelete.catPropedeuticoGralInput["persistenceVersion_string"]=data[0].persistenceVersion_string;
                                $scope.dataToSendDelete.catPropedeuticoGralInput["id"]=data[0].id;
                                $scope.dataToSendDelete.catPropedeuticoGralInput["clave"]=data[0].clave;
                                $scope.dataToSendDelete.catPropedeuticoGralInput["descripcion"]=data[0].descripcion;
                                $scope.dataToSendDelete.catPropedeuticoGralInput["isEliminado"]=true;
                                ...
                                return $http(req)
                                    .success(function(dataResponse, status) {
                                        $scope.dataToSendDelete.catPropedeuticoGralInput["catRelacionCampusTipo"]=dataResponse
                                        console.log($scope.dataToSendDelete);
                                        $scope.properties.selectedRow = row;
                                        $scope.$apply();
                                        startProcess();
                                    })
    ...
    function doRequestDelete(method, url, params) {
       let datos = angular.copy($scope.dataToSendDelete);
        var req = {
            method: method,
            url: url,
            data: datos,
