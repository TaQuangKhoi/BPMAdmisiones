    ...
    $scope.sendData = function() {
        ...
        if ($scope.loading == false) {
            ...
            if ($scope.properties.isModificacion === false) {
                ...
                $scope.properties.contenido[$scope.properties.index].isEnabled = $scope.properties.nuevosValores[0].isEnabled;
                $scope.properties.contenido[$scope.properties.index].isEliminado = $scope.properties.nuevosValores[0].isEliminado;
