function PbButtonCtrl($scope, $http, $location, $log, $window, localStorageService, modalService, blockUI) {
    ...
    $scope.getComentarios = function() {
        ...
        var req = {
            method: "GET",
            url: `/API/bdm/businessData/com.anahuac.bitacora.CatBitacoraComentarios?q=getCatBitacoraComentariosByUser&p=0&c=9999&f=usuario=${$scope.properties.getUser != null?$scope.properties.getUser:''}`
        };

        return $http(req)
            .success(function(data, status) {
                $scope.properties.dataReturn = data;
            })
            .error(function(data, status) {
    ...
    $scope.$watch('properties.getUser', function(value) {
