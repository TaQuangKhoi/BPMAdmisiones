function PbTableCtrl($scope, $http, $window, blockUI) {
    ...
    $scope.redirecc = function(row){
        ...
        var req = {
            method: "POST",
            url: "/bonita/API/extension/AnahuacRest?url=postAspiranteSesionesByUsername&p=0&c=10",
            data: str,
        };
         return $http(req)
            .success(function (data, status) {
                if(data.data.length < 1){
                    ...
                    var url = "/portal/resource/app/administrativo/AvanzarPaseLista/content/?&idbanner="+row.idbanner;
