function PbButtonCtrl($scope, modalService, $http, blockUI, $q, $filter) {
  ...
  $scope.caseId = GET_parameters.caseId;
      ...
      $scope.loadCaseId= function(){
          ...
          doc.text(margenSegundaFila-10, (height / 2) - 140, 'Fecha:');  
          doc.text($scope.fechaActual, 145, (height / 2) - 140);
          doc.setFontSize(fontSubTitle);
          doc.text(margenSegundaFila-10, (height / 2) - 135, 'Usuario:');
          doc.text($scope.properties.data.user_name, 145, (height / 2) - 135);
          ...
          doc.text($scope.properties.PDFobjSolicitudDeAdmision.fechaNacimiento == null? 'N/A':$scope.properties.PDFobjSolicitudDeAdmision.fechaNacimiento.slice(0,10), respuestasFilaIntermedia, (height / 2) + 15);
          ...
          doc.text(($scope.properties.PDFobjSolicitudDeAdmision.catEstado.descripcion == "" || $scope.properties.PDFobjSolicitudDeAdmision.catEstado.descripcion == null ? $scope.properties.PDFobjSolicitudDeAdmision.estadoExtranjero : $scope.properties.PDFobjSolicitudDeAdmision.catEstado.descripcion), respuestasSegundaFila, (height / 2) + 75);
          ...
          doc.text(($scope.properties.PDFobjSolicitudDeAdmision.numExterior == "" || $scope.properties.PDFobjSolicitudDeAdmision.numExterior == null  ? "N/A" : $scope.properties.PDFobjSolicitudDeAdmision.numExterior), respuestasSegundaFila, (height / 2) + 104);
  
          doc.text(($scope.properties.PDFobjSolicitudDeAdmision.numInterior == "" || $scope.properties.PDFobjSolicitudDeAdmision.numInterior == null  ? "N/A" : $scope.properties.PDFobjSolicitudDeAdmision.numInterior), respuestasPrimeraFila, (height / 2) + 116);
          doc.text($scope.properties.PDFobjSolicitudDeAdmision.telefono, respuestasFilaIntermedia, (height / 2) + 116);
          doc.text(($scope.properties.PDFobjSolicitudDeAdmision.otroTelefonoContacto == "" || $scope.properties.PDFobjSolicitudDeAdmision.otroTelefonoContacto == null  ? "N/A" : $scope.properties.PDFobjSolicitudDeAdmision.otroTelefonoContacto), respuestasSegundaFila, (height / 2) + 116);
          ...
          //$scope.properties.PDFobjTutor.forEach(function(PDFitem, i, objeto) {
                  ...
                  doc.text(($scope.properties.PDFobjTutor[0].puesto == "" || $scope.properties.PDFobjTutor[0].puesto == null ? "No trabaja" : $scope.properties.PDFobjTutor[0].puesto), respuestasPrimeraFila, (height / 2) - 35);
                  doc.text(($scope.properties.PDFobjTutor[0].empresaTrabaja == "" || $scope.properties.PDFobjTutor[0].empresaTrabaja == null ? "No trabaja" : $scope.properties.PDFobjTutor[0].empresaTrabaja), respuestasFilaIntermedia, (height / 2) - 35);
                  ...
                  doc.text(($scope.properties.PDFobjTutor[0].numeroExterior == "" || $scope.properties.PDFobjTutor[0].numeroExterior == null  ? "N/A" : $scope.properties.PDFobjTutor[0].numeroExterior), respuestasFilaIntermedia, (height / 2) + 24);
                  doc.text(($scope.properties.PDFobjTutor[0].numeroInterior == "" || $scope.properties.PDFobjTutor[0].numeroInterior == null ? "N/A" : $scope.properties.PDFobjTutor[0].numeroInterior), respuestasSegundaFila, (height / 2) + 24);
          ...
          doc.text(($scope.properties.PDFobjPadre.numeroExterior == "" || $scope.properties.PDFobjPadre.numeroExterior == null ? "N/A" : $scope.properties.PDFobjPadre.numeroExterior), respuestasFilaIntermedia, (height / 2) - 71);
          doc.text(($scope.properties.PDFobjPadre.numeroInterior == "" || $scope.properties.PDFobjPadre.numeroInterior == null ? "N/A" : $scope.properties.PDFobjPadre.numeroInterior), respuestasSegundaFila, (height / 2) - 71);
          ...
          doc.text(($scope.properties.PDFobjMadre.numeroExterior == "" || $scope.properties.PDFobjMadre.numeroExterior == null? "N/A" : $scope.properties.PDFobjMadre.numeroExterior), respuestasFilaIntermedia, (height / 2) + 52);
          doc.text(($scope.properties.PDFobjMadre.numeroInterior == "" || $scope.properties.PDFobjMadre.numeroInterior == null ? "N/A" : $scope.properties.PDFobjMadre.numeroInterior), respuestasSegundaFila, (height / 2) + 52);
