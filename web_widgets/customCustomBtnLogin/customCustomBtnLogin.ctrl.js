function PbButtonCtrl($scope, $http, $location, $log, $window, localStorageService, modalService) {
  ...
  icon: 'error',
  html:
    'Correo electronico o Contraseña incorrecta. <br><br><br><br><p class="swal2-title">Recuerda</p> <p>Si tu registro lo realisaste <stron>antes</stron> del 30 de abril del 2021 <br> da clic aquí </p>' +
