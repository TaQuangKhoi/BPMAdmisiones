function loadUsuariosDuplicadosCtrl($scope, $http) {
    ...
    $scope.loadUsuariosDuplicados = function(parametros) {
        var url = "../API/extension/AnahuacRestGet?url=getDuplicado&idbanner=[IDBANNER]&caseid=[CASEID]&curp=[CURP]&primerNombre=[PRIMERNOMBRE]&segundoNombre=[SEGUNDONOMBRE]&apellidoPaterno=[APELLIDOPATERNO]&apellidoMaterno=[APELLIDOMATERNO]&sexo=[SEXO]&p=0&c=9999";
