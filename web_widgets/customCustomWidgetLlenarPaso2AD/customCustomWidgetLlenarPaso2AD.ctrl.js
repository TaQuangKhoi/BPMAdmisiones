        ...
        for (let i = 0; i < _gradosEscolares.length; i++) {
            if (_gradosEscolares[i].descripcion === "Preparatoria/Bachillerato") {
                ...
                let infoEscolar = {
                    ...
                    "catBachillerato": null,
                    "otraEscuela": $scope.properties.bdmSolicitud.catBachilleratos.descripcion !== "Otro" ? "" : $scope.properties.bdmSolicitud.bachillerato,
                    // "estadoString": $scope.properties.bdmSolicitud.estadoBachillerato,
                    "estadoString": $scope.properties.bdmSolicitud.catBachilleratos.descripcion !== "Otro" ? $scope.properties.bdmSolicitud.catBachilleratos.estado : $scope.properties.bdmSolicitud.estadoBachillerato,
                    "persistenceId_string": null,
                    "isDefault": true
                }
