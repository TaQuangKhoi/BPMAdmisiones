function PbTableCtrl($scope, $http, $window,blockUI) {
    ...
    $scope.cargaManual = function(row){
        ...
        var req = {
            method: "GET",
            url: `/API/extension/AnahuacRestGet?url=getAspiranteRC&p=0&c=10&idbanner=${row.idbanner}`
        };
        return $http(req)
            .success(function (data, status) {
