        ...
        if ($scope.loading == false) {
            ...
            if($scope.properties.isModificacion === false){
               ...
               //console.log($scope.properties.contenido)
                ...
                $scope.properties.contenido[$scope.properties.index].fechaImplementacion = $scope.properties.nuevosValores[0].fechaImplementacion;
                $scope.properties.contenido[$scope.properties.index].urlAvisoPrivacidad = $scope.properties.nuevosValores[0].urlAvisoPrivacidad;
                $scope.properties.contenido[$scope.properties.index].urlDatosVeridicos = $scope.properties.nuevosValores[0].urlDatosVeridicos;
                $scope.properties.contenido[$scope.properties.index].urlAutorDatos = $scope.properties.nuevosValores[0].urlAutorDatos;
                $scope.properties.contenido[$scope.properties.index].id = $scope.properties.nuevosValores[0].id;
