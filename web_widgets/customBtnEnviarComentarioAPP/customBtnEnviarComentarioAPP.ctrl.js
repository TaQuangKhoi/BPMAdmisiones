function PbButtonCtrl($scope, $http, $location, $log, $window, localStorageService, modalService) {
  ...
  $scope.getComentarios = function() {
        var req = {
            method: "GET",
            url: "/bonita/API/bdm/businessData/com.anahuac.bitacora.CatBitacoraComentarios?q=getCatBitacoraComentariosByUser&p=0&c=9999&f=usuario="+$scope.properties.getUser
        };
