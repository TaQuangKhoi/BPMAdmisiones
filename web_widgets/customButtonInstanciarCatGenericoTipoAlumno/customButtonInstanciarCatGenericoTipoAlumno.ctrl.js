...
function startProcess() {
    ...
    function checkclave(funcion){
        if(funcion === 'agregar'){
            var req = {
                method: 'GET',
                url: "/API/extension/AnahuacRestGet?url=getValidarClave&p=0&c=10&tabla=CATTIPOALUMNO&clave=" + $scope.properties.dataToChange2[$scope.properties.nombreTabla][0].clave + "&id="
            };
        }else{
            var req = {
                method: 'GET',
                url: "/API/extension/AnahuacRestGet?url=getValidarClave&p=0&c=10&tabla=CATTIPOALUMNO&clave=" + $scope.properties.dataToChange2.clave + "&id=" + $scope.properties.dataToChange2.persistenceId
            };
        }
