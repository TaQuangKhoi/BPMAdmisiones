function PbTableCtrl($scope, $http, $location, $log, $window, localStorageService, modalService) {
    ...
    this.selectRow = function(row) {
        ...
        $scope.properties.selectedRow.idCampus = $scope.properties.idCampus;
    ...
    $scope.$watch("properties.reloadTable", ()=>{
        if($scope.properties.reloadTable == true){
            doRequestGet();
        }
    });
}